...
void loop() {
  ...
  // Default response
  client.println("HTTP/1.1 200 OK\r\nContent-Type: text/plain\r\n");
  client.println("Plant Monitor Active - Visit http://192.168.0.33/temperature_monitor/live_dashboard.php for dashboard");
  client.stop();
  delay(10);
}
